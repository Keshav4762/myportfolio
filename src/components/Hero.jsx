        ...
        <div className='flex flex-wrap '>
            <div className='w-full lg:w-1/2'>
                <div className='flex flex-col items-center lg:items-start'>
                    <motion.h1 animate={{ rotate: 360 }} className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl '>Keshav Kartik Sharma</motion.h1>
                    <span className='bg-gradient-to-r from-pink-300 via-sky-500 to-purple-500 bg-clip-text text-3xl tracking-tight text-transparent'>Full Stack Developer</span>
